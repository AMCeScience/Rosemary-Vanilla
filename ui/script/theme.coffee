...
_init = ->
  ...
  $.AdminLTE.tree = (menu) ->
    ...
    $(document).on 'click', menu + ' li a', (e) ->
      ...
      if checkElement.is('.treeview-menu') and checkElement.is(':visible') and !$('body').hasClass('sidebar-collapse')
        #Close the menu
  ...
  $.AdminLTE.controlSidebar =
    activate: ->
      ...
      $(document).on 'click', o.toggleBtnSelector, (e) ->
        e.preventDefault()
...
(($) ->
  ...
  $.fn.toggleBox = ->
    button = $($.AdminLTE.boxWidget.selectors.collapse, this)
    $.AdminLTE.boxWidget.collapse button

  $.fn.removeBox = ->
    button = $($.AdminLTE.boxWidget.selectors.remove, this)
